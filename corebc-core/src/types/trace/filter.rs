...
use crate::types::{Address, BlockNumber, Bytes, H176, H256, U256};
...
impl TraceFilter {
    ...
    #[allow(clippy::wrong_self_convention)]
    #[must_use]
    pub fn to_address(mut self, address: Vec<H176>) -> Self {
    ...
    #[allow(clippy::wrong_self_convention)]
    #[must_use]
    pub fn from_address(mut self, address: Vec<H176>) -> Self {
...
mod tests {
    ...
    const EXAMPLE_TRACE_SUICIDE: &str = r#"{
        "action": {
            "address": "0x0000d1220a0cf47c7b9be7a2e6ba89f429762e7b9adb",
            "refundAddress": "0x0000fb6916095ca1df60bb79ce92ce3ea74c37c5d359",
            "balance": "0x0"
        },
        "blockHash": "0x6474a53a9ebf72d306a1406ec12ded12e210b6c3141b4373bfb3a3cea987dfb8",
        "blockNumber": 988775,
    ...
    const EXAMPLE_TRACE_REWARD: &str = r#"{
        "action": {
            "author": "0x0000d1220a0cf47c7b9be7a2e6ba89f429762e7b9adb",
            "value": "0x0",
            "rewardType": "block"
        },
        "blockHash": "0x6474a53a9ebf72d306a1406ec12ded12e210b6c3141b4373bfb3a3cea987dfb8",
