...
impl Eip2930TransactionRequest {
    ...
    pub fn rlp(&self) -> Bytes {
        ...
        let network_id = self.tx.network_id.unwrap_or_else(U64::one);
    ...
    fn decode_base_rlp(rlp: &rlp::Rlp, offset: &mut usize) -> Result<Self, rlp::DecoderError> {
        let network_id: u64 = rlp.val_at(*offset)?;
        *offset += 1;

        let mut request = TransactionRequest::decode_unsigned_rlp_base(rlp, offset)?;
        request.network_id = Some(U64::from(network_id));
...
// CORETODO: Eip2930 was part of the Berin upgrade which means we don't need to fix these tests.
// I left it here in case we will want to use it in the future
// #[cfg(test)]
// mod tests {
...
//         let expected =
// "b86601f8630103018261a894b94f5374fce5edbc8e2a8697c15331677e6ebf0b0a825544c001a0c9519f4f2b30335884581971573fadf60c6204f59a911df35ee8a540456b2660a032f1e8e2c5dd761f9e4f88f41c8310aeaba26a8bfcdacfedfa12ec3862d37521"
...
//         let raw_tx =
// hex::decode("
// "
// ).unwrap();         let expected_tx = TransactionRequest::new()
//             .network_id(1u64)
//             .nonce(2310u64)
...
//
// .data(hex::decode("
// "
// ).unwrap())
...
//         let raw_tx =
// hex::decode("
// "
// ).unwrap();         let expected_tx = TransactionRequest::new()
//             .network_id(1u64)
//             .nonce(9215u64)
...
//                 AccessListItem {
//                     address:
// Address::from_str("0x25647e01bd0967c1b9599fa3521939871d1d0888").unwrap(),
// storage_keys: vec![],                 },
//             ]));
