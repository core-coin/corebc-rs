...
///   * [Hash]
///
/// [Source]: corebc_contract_abigen::Source
...
///
/// ```ignore
/// use corebc_contract::{EthAbiCodec, EthAbiType};
...
///
/// ```ignore
/// use corebc_contract::{EthDisplay, EthAbiType};
/// use corebc_core::types::*;
///
