...
use corebc_core::{
    ...
    macros::{corebc_contract_crate, corebc_core_crate, corebc_providers_crate},
    types::Bytes,
};
...
impl Context {
    ...
    pub fn expand(&self) -> Result<ExpandedContract> {
        ...
        let contract = quote! {
                ...
                impl<M: #corebc_providers::Middleware> From<#corebc_contract::Contract<M>> for #name<M> {
    ...
    pub(crate) fn struct_declaration(&self) -> TokenStream {
        ...
        let abi = {
            ...
            quote! {
                ...
                #[doc = #doc_str]
                pub static #abi_name: #corebc_contract::Lazy<#corebc_core::abi::Abi> =
                    #corebc_contract::Lazy::new(|| #parse.expect("ABI is always valid"));
            }
        };
        ...
        quote! {
            ...
            // Struct declaration
            pub struct #name<M>(#corebc_contract::Contract<M>);
