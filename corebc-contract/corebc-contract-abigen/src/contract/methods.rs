...
impl Context {
    ...
    pub(crate) fn deployment_methods(&self) -> Option<TokenStream> {
        ...
        let corebc_contract = corebc_contract_crate();
        ...
        Some(quote! {
            ...
            ///
            /// ```ignore
            /// # async fn deploy<M: corebc::providers::Middleware>(client: ::std::sync::Arc<M>) {
            ...
            pub fn deploy<T: #corebc_core::abi::Tokenize>(
                ...
                constructor_args: T,
            ) -> ::core::result::Result<#corebc_contract::builders::ContractDeployer<M, Self>, #corebc_contract::ContractError<M>> {
                let factory = #corebc_contract::ContractFactory::new(#get_abi, #get_bytecode, client);
                let deployer = factory.deploy(constructor_args)?;
                let deployer = #corebc_contract::ContractDeployer::new(deployer);
                Ok(deployer)
            }
        })
    }
    ...
    fn expand_call_struct(
        ...
        Ok(quote! {
            #[doc = #doc_str]
            #[derive(Clone, #corebc_contract::EthCall, #corebc_contract::EthDisplay, #derives)]
    ...
    pub fn expand_return_struct(
        ...
        Ok(Some(quote! {
            #[doc = #doc_str]
            #[derive(Clone, #corebc_contract::EthAbiType, #corebc_contract::EthAbiCodec, #derives)]
    ...
    fn expand_call_structs(&self, aliases: BTreeMap<String, MethodAlias>) -> Result<TokenStream> {
        ...
        let tokens = quote! {
            ...
            #[derive(Clone, #corebc_contract::EthAbiType, #derives)]
            pub enum #enum_name {
    ...
    fn expand_function(
        ...
        Ok(quote! {
            #[doc = #doc_str]
            pub fn #function_name(&self #function_params) -> #corebc_contract::builders::ContractCall<M, #outputs> {
