...
// /// };
// /// use corebc_contract::{Contract, Multicall, MulticallVersion};
...
// network     /// ID. Uses the [default multicall address](constants::MULTICALL_ADDRESS) if no
// address is     /// provided.
//     ///
//     /// # Errors
//     ///
...
//     /// # Panics
//     ///
//     /// If neither an address or network_id are provided. Since this is not an async function, it
...
// the     /// randomness beacon provided by the beacon network.
...
//     /// Appends a `call` to the list of calls of the Multicall instance for querying the network
// id.     pub fn add_get_network_id(&mut self) -> &mut Self {
...
//     /// # use corebc_contract::{Multicall, Contract};
