...
- corebc-blockindex solc feature ([#1965](https://github.com/gakonst/ethers-rs/issues/1965))
...
- Set `GoCoreInstance` p2p_port in spawn ([#1933](https://github.com/gakonst/ethers-rs/issues/1933))
...
- Add support for GoCore built-in tracer and config ([#2121](https://github.com/gakonst/ethers-rs/issues/2121))
...
- Expose genesis and private key in GoCore ([#2091](https://github.com/gakonst/ethers-rs/issues/2091))
...
- GoCoreTrace shouldn't have 0x prefix for return_value ([#1705](https://github.com/gakonst/ethers-rs/issues/1705))
- Remove default include paths ([#1691](https://github.com/gakonst/ethers-rs/issues/1691))
- GoCore structlog memory ([#1690](https://github.com/gakonst/ethers-rs/issues/1690))
- GoCore trace types ([#1682](https://github.com/gakonst/ethers-rs/issues/1682))
...
- Clarify GoCore trace structs ([#1626](https://github.com/gakonst/ethers-rs/issues/1626))
...
- Double shuttle startup time ([#1702](https://github.com/gakonst/ethers-rs/issues/1702))
...
- Add --fork-block-number setter for shuttle bindings ([#1468](https://github.com/gakonst/ethers-rs/issues/1468))
...
- Add shuttle hardhat chain id ([#1356](https://github.com/gakonst/ethers-rs/issues/1356))
...
- Add shuttle bindings ([#1164](https://github.com/gakonst/ethers-rs/issues/1164))
...
- Add Anvil::at and shuttle example ([#1486](https://github.com/gakonst/ethers-rs/issues/1486))
...
- Make corebc-blockindex compile for wasm32 ([#1403](https://github.com/gakonst/ethers-rs/issues/1403))
...
- Drop shuttle stdout ([#1759](https://github.com/gakonst/ethers-rs/issues/1759))
...
- Replace ganache with shuttle ([#1286](https://github.com/gakonst/ethers-rs/issues/1286))
...
- Multiple Ylem Version detection ([#551](https://github.com/gakonst/ethers-rs/issues/551))
- Add solc svm find support ([#547](https://github.com/gakonst/ethers-rs/issues/547))
- Use corebc-ylem::Ylem instead of corebc_core::utils::Ylem ([#546](https://github.com/gakonst/ethers-rs/issues/546))
...
- GoCore TxPool API Support ([#86](https://github.com/gakonst/ethers-rs/issues/86))
