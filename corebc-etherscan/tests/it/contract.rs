...
use corebc_etherscan::contract::SourceCodeMetadata;
use serial_test::serial;

/// Abi of [0xBB9bc244D798123fDe783fCc1C72d3Bb8C189413](https://api.etherscan.io/api?module=contract&action=getsourcecode&address=0x0000BB9bc244D798123fDe783fCc1C72d3Bb8C189413).
const DAO_ABI: &str = include!("../../../testdata/the_dao_abi.expr");

// CORETODO - fix this test after fixing blockchain explorer
// #[tokio::test]
// #[serial]
// async fn can_fetch_ftm_contract_abi() {
//     run_with_client(Network::Devin, |client| async move {
//         let _abi = client
//             .contract_abi("0x000080AA7cb0006d5DDD91cce684229Ac6e398864606".parse().unwrap())
//             .await
//             .unwrap();
//     })
//     .await;
...
//         let abi = client
//             .contract_abi("0x0000BB9bc244D798123fDe783fCc1C72d3Bb8C189413".parse().unwrap())
//             .await
//             .unwrap();
...
//     init_tracing();
//     run_with_client(Network::Mainnet, |client| async move {
//         let addr = "0x0000b5c31a0e22cae98ac08233e512bd627885aa24e5".parse().unwrap();
