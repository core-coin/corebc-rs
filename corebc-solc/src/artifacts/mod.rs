...
impl Settings {
    ...
    ///
    /// ```
    /// use corebc_solc::artifacts::output_selection::ContractOutputSelection;
    /// use corebc_solc::artifacts::Settings;
...
impl Libraries {
    ...
    ///
    /// ```
    /// use corebc_solc::artifacts::Libraries;
...
impl SourceFiles {
    ...
    /// use corebc_solc::artifacts::SourceFiles;
