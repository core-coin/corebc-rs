...
impl<T: ArtifactOutput> ProjectCompileOutput<T> {
    ...
    /// use corebc_solc::ConfigurableContractArtifact;
    /// use corebc_solc::{ArtifactId, Project};
    ///
    ...
    /// ```no_run
    /// use std::collections::btree_map::BTreeMap;
    /// use corebc_solc::{ConfigurableContractArtifact, Project};
    ///
    /// let project = Project::builder().build().unwrap();
    ...
    /// ```no_run
    /// use std::collections::btree_map::BTreeMap;
    /// use corebc_solc::artifacts::contract::Contract;
    /// use corebc_solc::Project;
    ///
    /// let project = Project::builder().build().unwrap();
    ...
    /// ```
    /// use corebc_solc::Project;
    /// use corebc_solc::artifacts::*;
    /// use corebc_solc::info::ContractInfo;
    ///
...
impl ProjectCompileOutput<ConfigurableArtifacts> {
    ...
    /// use corebc_solc::{ArtifactId, Project};
    /// use corebc_solc::contracts::ArtifactContracts;
    ///
    /// let project = Project::builder().build().unwrap();
