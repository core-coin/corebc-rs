...
mod tests {
    ...
    fn energy_price_increases_with_time() {
        ...
        assert_eq!(oracle.get_energy_price(initial_price, 60), 1100.into());
        assert_eq!(oracle.get_energy_price(initial_price, 119), 1100.into());
        assert_eq!(oracle.get_energy_price(initial_price, 120), 1200.into());
        assert_eq!(oracle.get_energy_price(initial_price, 1200), 3000.into());
    }
