...
- Add support for GoCore `debug_traceCall` [#1949](https://github.com/gakonst/ethers-rs/pull/1949)
- Add support for GoCore built-in tracer and config [#2121](https://github.com/gakonst/ethers-rs/pull/2121)
...
- Add support for GoCore `debug_traceTransaction` [#1469](https://github.com/gakonst/ethers-rs/pull/1469)
...
- [#1634](https://github.com/gakonst/ethers-rs/pull/1634) Derive missing `Clone`, `Copy` and `Debug` impls in corebc-blockindex.
...
- Bundle svm, svm-builds and sha2 dependencies in new `yvm-ylem` feature
